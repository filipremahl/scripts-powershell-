...
function New-LabVM
{
  ...
  ( 
    ...
    [int64]$MemoryStartupBytes = 3072MB,
  ...
  Process
  {
    ...
    New-VM -Name $VMName -MemoryStartupBytes $MemoryStartupBytes -SwitchName $VMSwitch -VHDPath $maindiskpath -Generation 1 -BootDevice VHD
    #endregion
